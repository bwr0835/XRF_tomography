...
x0_coarse_idx, y0_coarse_idx = int(np.unravel_index(np.argmin(np.abs(x_um_coarse - x0_fine)), x_um_coarse.shape)), np.unravel_index(np.argmin(np.abs(y_um_coarse - y0_fine)), y_um_coarse.shape)
