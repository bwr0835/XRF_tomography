...
im2_3 = axs2[1, 0].imshow(synth_proj_array_mlem_no_shift[:, 0, :])
im2_4 = axs2[1, 1].imshow(aligned_proj_array_shift_20[:, 0, :])
im2_5 = axs2[2, 0].imshow(synth_proj_array_gridrec_shift_20[:, 0, :])
im2_6 = axs2[2, 1].imshow(synth_proj_array_mlem_shift_20[:, 0, :])
