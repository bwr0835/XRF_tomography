        ...
        for element_idx in range(n_elements):
            if element_idx == ref_element_idx:
                for theta_idx in range(n_theta):
                    ...
                    aligned_proj[element_idx, theta_idx, :, :] = sr.register_transform(ref = proj_imgs_from_3d_recon[ref_element_idx, theta_idx, :, :], mov = reference_projection_imgs[theta_idx])
