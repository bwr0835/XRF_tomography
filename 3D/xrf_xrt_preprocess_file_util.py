...
def create_incremental_shifts_vs_angle_plot(dir_path,
    ...
    if correction_type == 'iter_reproj':
        ...
        axs1.scatter(theta_array, net_x_shift_array, s = 80, marker = 'o', linewidth = 2, color = 'k', label = r'$\delta x$')
        axs1.scatter(theta_array, net_y_shift_array, s = 80, marker = 'o', linewidth = 2, color = 'r', label = r'$\delta y$')
