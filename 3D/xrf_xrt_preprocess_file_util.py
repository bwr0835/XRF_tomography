...
def create_h5_aligned_aggregate_xrf_xrt(dir_path,
    ...
    with h5py.File(output_file_path, 'w') as f:
        ...
        data.create_dataset('xrf', data = elements_xrf, compression = 'gzip', compression_opts = 6)
        data.create_dataset('xrt', data = elements_xrt, compression = 'gzip', compression_opts = 6)
