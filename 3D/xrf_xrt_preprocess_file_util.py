...
def create_nonaligned_norm_non_cropped_proj_data_gif(dir_path,
    ...
    if norm_enabled:
        ...
        im3_1 = axs3[0].imshow(counts_xrt_norm[:, 0], vmin = vmin_xrt_norm, vmax = vmax_xrt_norm, aspect = 0.5)
        im3_2 = axs3[1].imshow(opt_dens[:, 0], vmin = vmin_opt_dens, vmax = vmax_opt_dens, aspect = 0.5)
        im3_3 = axs3[2].imshow(counts_xrf_ref_element_norm[:, 0], vmin = vmin_xrf_norm, vmax = vmax_xrf_norm, aspect = 0.5)
