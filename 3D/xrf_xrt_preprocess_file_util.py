...
def create_center_of_rotation_figures(dir_path,
    ...
    if sample_flipped_remounted_mid_experiment:
        ...
        overlay_shifted_0 = np.dstack((shifted_proj_img_array_element_to_align_with_theta_0_0_norm, np.flip(shifted_proj_img_array_element_to_align_with_theta_1_0_norm), np.zeros_like(shifted_proj_img_array_element_to_align_with_theta_0_0_norm)))
...
def create_incremental_shifts_vs_angle_plot(dir_path,
    ...
    if correction_type == 'iter_reproj':
        ...
        axs1.plot(theta_array, net_x_shift_array, marker = 'o', markersize = 5, linewidth = 2, color = 'k', label = r'$\delta x$')
        axs1.plot(theta_array, net_y_shift_array, marker = 'o', markersize = 5, linewidth = 2, color = 'r', label = r'$\delta y$')
